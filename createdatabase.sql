...
CREATE TABLE `City` (
  ...
  `State` char(20) CHARACTER SET utf8 NOT NULL DEFAULT '',
...
(47,'Tébessa','DDROPZA','Tébessa', 112007),
...
(1186,'Dewas','IND','MaDROPdhya Pradesh', 164364),
...
(1353,'Bansberia','INDDROP','West Bengali', 93447),
...
(3813,'Washington','USA','State of Columbia', 572059),
